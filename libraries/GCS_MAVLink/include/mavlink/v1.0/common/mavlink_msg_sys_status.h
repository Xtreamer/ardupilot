...
typedef struct __mavlink_sys_status_t
{
 ...
 uint16_t voltage_aux_battery; ///< Aux battery voltage, in millivolts (1 = 1 millivolt), -1: autopilot does not measure aux battery voltage
...
#define MAVLINK_MSG_ID_SYS_STATUS_CRC 149
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
	...
	{  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "voltage_aux_battery", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_sys_status_t, voltage_aux_battery) }, \
         { "drop_rate_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_sys_status_t, drop_rate_comm) }, \
         { "errors_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 22, offsetof(mavlink_sys_status_t, errors_comm) }, \
         { "errors_count1", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_sys_status_t, errors_count1) }, \
         { "errors_count2", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_sys_status_t, errors_count2) }, \
         { "errors_count3", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_sys_status_t, errors_count3) }, \
         { "errors_count4", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_sys_status_t, errors_count4) }, \
         { "battery_remaining", NULL, MAVLINK_TYPE_INT8_T, 0, 32, offsetof(mavlink_sys_status_t, battery_remaining) }, \
         } \
}
 ...
 * @param voltage_aux_battery Aux battery voltage, in millivolts (1 = 1 millivolt), -1: autopilot does not measure aux battery voltage
...
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t voltage_aux_battery, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4)
{
	...
	_mav_put_uint16_t(buf, 18, voltage_aux_battery);
	...
	packet.voltage_aux_battery = voltage_aux_battery;
...
{
	return mavlink_msg_sys_status_pack(system_id, component_id, msg, sys_status->onboard_control_sensors_present, sys_status->onboard_control_sensors_enabled, sys_status->onboard_control_sensors_health, sys_status->load, sys_status->voltage_battery, sys_status->current_battery, sys_status->battery_remaining, sys_status->voltage_aux_battery, sys_status->drop_rate_comm, sys_status->errors_comm, sys_status->errors_count1, sys_status->errors_count2, sys_status->errors_count3, sys_status->errors_count4);
}
...
/**
 * @brief Get field voltage_aux_battery from sys_status message
 *
 * @return Aux battery voltage, in millivolts (1 = 1 millivolt), -1: autopilot does not measure aux battery voltage
 */
static inline uint16_t mavlink_msg_sys_status_get_voltage_aux_battery(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
	...
	sys_status->voltage_aux_battery = mavlink_msg_sys_status_get_voltage_aux_battery(msg);
